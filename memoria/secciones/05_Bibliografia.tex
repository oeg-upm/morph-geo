\begin{thebibliography}{99}
    ...
    \bibitem{btn100}Repositorio GitHub BTN100,
    ...
    \bibitem{semantic-web} Tim Berners-Lee, James Hendler, Eric Miller,
    ...
    \bibitem{datos-ign}Iniciativa del Instituto Geográfico Nacional (IGN)
        \href{http://datos.ign.es/}{``http://datos.ign.es/''},
    \bibitem{geokettle-osg}GEOKettle, OSGeo Live Wiki
    ...
    \bibitem{pentaho}Pentaho Data Integration 9.1 Documentation
    ...
    \bibitem{triplegeo}TripleGeo Documentation
    ...
    \bibitem{pdi-spoon}Documentación PDI Spoon
    ...
    \bibitem{guia-diseno}Guia de diseño de plugins
    ...
    \bibitem{ogr2ogr}Documentación de la herramienta ogr2ogr

        \href{https://gdal.org/programs/ogr2ogr.html}{https://gdal.org/programs/ogr2ogr.html},
    \bibitem{outofmemory}Solución OutOfMemoryError
